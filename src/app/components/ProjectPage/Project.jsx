...
//   return (
//     <div
//       className={`group relative bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 transform opacity-0 animate-fade-in-up`}
...
//         />
//         {project.featured && (
//           <div className="absolute top-4 left-4 bg-gradient-to-r from-yellow-400 to-orange-500 text-white px-3 py-1 rounded-full text-sm font-semibold flex items-center gap-1 shadow-lg">
...
//             className="px-6 py-3 bg-white text-gray-800 font-semibold rounded-full hover:bg-gray-100 transition-colors duration-300 shadow-lg"
//           >
//             View Details
//           </Link>
//         </div>
...
//           <div>
//             <h3 className="text-xl font-bold text-gray-800 group-hover:text-emerald-600 transition-colors duration-300 mb-1">
//               {project.title}
//             </h3>
//             <p className="text-emerald-600 text-sm font-semibold">{project.category}</p>
//           </div>
//         </div>
...
//             <span key={tag} className="px-3 py-1 text-xs rounded-full bg-emerald-100 text-emerald-700 font-medium">
//               {tag}
//             </span>
//           ))}
...
//           <div className="flex items-center justify-between mt-4 text-emerald-600 font-semibold hover:text-emerald-700 transition-colors duration-300">
...
//       {/* Bottom accent line */}
//       <div className="absolute bottom-0 left-0 h-1 bg-gradient-to-r from-emerald-400 to-teal-400 w-0 group-hover:w-full transition-all duration-500" />
//     </div>
//   )
// }
...
//   const categories = ["All", "Web Development", "Mobile Development", "IoT", "Data Visualization", "EdTech"]
...
//         {/* Header */}
//         <div
//           className={`text-center mb-16 transform transition-all duration-1000 ${isLoaded ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}
//         >
...
//             Explore my portfolio of innovative digital solutions, from web applications to mobile apps and everything in
//             between.
//           </p>
//         </div>
...
//         {/* Search and Filter */}
//         <div
//           className={`mb-12 transform transition-all duration-1000 delay-200 ${isLoaded ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}
//         >
...
//                 className="w-full pl-12 pr-4 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors duration-300 shadow-sm"
//               />
//             </div>
...
//         {/* CTA Section */}
//         <div
//           className={`text-center mt-20 transform transition-all duration-1000 delay-500 ${isLoaded ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}
//         >
...
//               <Link
//                 href="/contact"
//                 className="inline-flex items-center gap-3 px-8 py-4 bg-white text-emerald-600 font-semibold rounded-full hover:shadow-xl transition-all duration-300 hover:scale-105"
//               >
...
//   return (
//     <div
//       className={`group relative bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 transform animate-fade-in-up`}
//       style={{ animationDelay: `${index * 100}ms` }}
//     >
//       <div className="relative h-64 w-full overflow-hidden">
//         <Image
...
// export default function ProjectsPage() {
//   const [isLoaded, setIsLoaded] = useState(true) // always true
//   const categories = ["All", "Web Development", "Mobile Development", "IoT", "Data Visualization", "EdTech"]
...
//         {/* Search and Filter (UI only, no logic) */}
//         <div
...
//                 <button
//                   key={category}
//                   className="px-4 py-2 rounded-full font-medium bg-white text-gray-400 cursor-not-allowed border border-gray-200"
//                 >
//                   {category}
//                 </button>
//               ))}
...
//         {/* Projects Grid (always shows all projects) */}
//         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
