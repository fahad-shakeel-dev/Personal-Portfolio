...
//                       </button>
//                       <div
//                         className={`absolute left-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-100 transition-all duration-300 transform origin-top ${
//                           isPortfolioOpen 
...
//               <Link
//                 href="/hire-me"
//                 className="px-6 py-3 bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-semibold rounded-lg hover:shadow-lg hover:shadow-emerald-500/25 transition-all duration-300 hover:scale-105"
//               >
//                 Hire Me
//               </Link>
//             </div>
...
//               <Link
//                 href="/hire-me"
//                 className="block w-full text-center py-4 bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-semibold rounded-full hover:shadow-lg transition-all duration-300"
//                 onClick={() => setIsMenuOpen(false)}
//               >
//                 Hire Me
//               </Link>
...
//                   <>
//                     {user && (
//                       <span className="block py-2 text-base text-gray-600 px-4">Welcome, {user.name}</span>
//                     )}
//                     <button
//                       onClick={handleLogout}
