...
// const Smartphone = dynamic(() => import("lucide-react").then((mod) => mod.Smartphone), { ssr: false })
...
//         filterRef.current.scrollIntoView({ block: "nearest", behavior: "smooth" })
...
//         {/* Loading State */}
//         {loading && (
//           <div className="text-center text-gray-300 text-base sm:text-lg">Loading technologies...</div>
//         )}

//         {/* Category Filter */}
//         <div
//           ref={filterRef}
//           className={`flex flex-wrap justify-center gap-2 sm:gap-4 mb-8 sm:mb-12 transform transition-all duration-1000 delay-200 will-change-transform,opacity ${
//             isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
//           }`}
//           role="tablist"
...
//             <div
//               key={tech.name}
//               className={`group relative bg-white/5 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-white/10 hover:border-emerald-500/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-emerald-500/10 transform ${
//                 isVisible
...
//         {/* CTA Section */}
//         <div
//           className={`text-center mt-12 sm:mt-16 transform transition-all duration-1000 delay-500 will-change-transform,opacity ${
//             isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
//           }`}
//         >
...
//               key={tech.name}
//               className={`group relative bg-white/5 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-white/10 hover:border-emerald-500/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-emerald-500/10 transform ${
//                 isVisible && (showAll || index < (typeof window !== "undefined" && window.innerWidth >= 1024 ? 8 : 6))
//                   ? "translate-x-0 opacity-100"
//                   : "translate-x-12 opacity-0"
//               }`}
//               style={{ transitionDelay: `${index * 50}ms` }}
...
//         {/* View More Button */}
//         {filteredTechnologies.length > (typeof window !== "undefined" && window.innerWidth >= 1024 ? 8 : 6) && !showAll && (
...
//     // Maintain scroll position to keep filter row in view
//     setTimeout(() => {
//       if (scrollPosition.current && filterRef.current) {
//         // Calculate the position of the filter row relative to viewport
//         const filterRect = filterRef.current.getBoundingClientRect()
        
//         // If filter row is not in view, scroll to it
//         if (filterRect.top < 0 || filterRect.bottom > window.innerHeight) {
...
//         <div
//           ref={filterRef}
//           className={`flex flex-wrap justify-center gap-2 sm:gap-4 mb-8 sm:mb-12 sticky top-4 z-20 bg-gradient-to-b from-gray-900/80 via-slate-800/80 to-emerald-900/80 backdrop-blur-md py-2 rounded-lg transform transition-all duration-1000 delay-200 will-change-transform,opacity ${
//             isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
//           }`}
//           role="tablist"
//           aria-label="Technology Categories"
...
//             <div
//               key={tech.name}
//               className={`group relative bg-white/5 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-white/10 hover:border-emerald-500/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-emerald-500/10 fade-in-right ${
