...
export function ServicesSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="py-16 px-4 sm:px-6 lg:px-8 mx-auto overflow-hidden bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50"
      role="region"
    ...
    >
      {/* Background Elements */}
      <div className="absolute pt-14 inset-0 pointer-events-none">
