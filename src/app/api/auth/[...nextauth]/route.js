...
//           userImg: user.image || profile.picture || null, // 👈 store profile picture
//           isVerified: true,
//           isActive: true,
//           password: null,
//         });
...
//         if (!dbUser.userImg) {
//           dbUser.userImg = user.image || profile.picture || null;
//         }
//         await dbUser.save();
//       }
...
//         token.userImg = user.image || profile.picture || null; // 👈 include in token
//       }
...
//       session.user.userImg = token.userImg; // 👈 add to session
