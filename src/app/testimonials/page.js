...
//   const [formData, setFormData] = useState({ fullName: '', email: '', company: '', role: '', quote: '', rating: 5 });
...
//           setFormData({ fullName: '', email: '', company: '', role: '', quote: '', rating: 5 });
//         }
...
//         // Fetch user's testimonial if authenticated
//         if (authRes.ok) {
...
//   useEffect(() => {
//     if (testimonials.length <= 1) return; // Prevent auto-scroll if no testimonials
...
//         setFormData({ fullName: formData.fullName, email: formData.email, company: '', role: '', quote: '', rating: 5 });
...
//                 <img
//                   src={testimonials[0].avatar || 'https://via.placeholder.com/150'}
...
//           {isModalOpen && (
//             <div className="fixed inset-0 backdrop-blur-md bg-gray-500/10 flex items-center justify-center z-50 overflow-auto p-4">
//               <div
//                 ref={modalRef}
...
//           {isModalOpen && (
//             <div className="fixed inset-0 backdrop-blur-md bg-gray-500/10 flex items-center justify-center z-50 overflow-hidden p-4">
//               <div
//                 ref={modalRef}
//                 className="bg-white rounded-2xl w-full max-w-md sm:max-w-lg mx-auto relative max-h-[90vh] overflow-y-auto"
//               >
