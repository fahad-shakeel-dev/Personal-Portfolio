...
//   // Check for verified query parameter from verification redirect
//   if (typeof window !== 'undefined') {
//     const urlParams = new URLSearchParams(window.location.search);
//     if (urlParams.get('verified') === 'true' && !message) {
...
//     window.location.href = process.env.NEXT_PUBLIC_GOOGLE_OAUTH_URL || '/api/auth/google';
//   };
