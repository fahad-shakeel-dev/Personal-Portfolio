...
//       <div className="flex">
//         {/* Sidebar */}
//         <aside className="w-64 min-h-screen bg-white shadow-lg border-r border-emerald-100">
...
//               <a
//                 href="/admin"
//                 className="flex items-center px-4 py-3 text-emerald-700 bg-emerald-50 rounded-lg hover:bg-emerald-100 transition-colors"
//               >
