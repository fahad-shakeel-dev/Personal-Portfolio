...
//     formData.append("id", selectedProject.id);
//     Object.entries(projectData).forEach(([key, value]) => {
//       if (key !== "features" && key !== "gallery" && key !== "deletedGalleryImages") {
//         formData.append(key, value);
//       }
//     });
//     if (projectData.features && projectData.features.length > 0) {
//       projectData.features.forEach((feature) => formData.append("features", feature));
//     }
//     if (projectData.deletedGalleryImages && projectData.deletedGalleryImages.length > 0) {
//       formData.append("deletedGalleryImages", JSON.stringify(projectData.deletedGalleryImages));
//     }
//     if (imageFile) {
//       formData.append("image", imageFile);
//     }
...
// const [deletedGalleryImages, setDeletedGalleryImages] = useState([]); // New state to track deleted images
...
//                 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
//                   <div>
//                     <label className="block text-sm font-medium text-emerald-700 mb-2">Created Date</label>
//                     <input
//                       type="date"
//                       required
...
//                   </div>
//                   <div>
//                     <label className="block text-sm font-medium text-emerald-700 mb-2">Completed Date</label>
//                     <input
//                       type="date"
//                       value={formData.completedDate}
//                       onChange={(e) => setFormData({ ...formData, completedDate: e.target.value })}
//                       disabled={formData.status !== "completed"}
//                       className="w-full px-4 py-2 border border-emerald-200 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 disabled:opacity-50"
//                     />
//                   </div>
//                 </div>
//                 <div>
